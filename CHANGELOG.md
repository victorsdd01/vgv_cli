...
### Changes
- Merge pull request #80 from victorsdd01/develop
...
### Changes
- Merge pull request #76 from victorsdd01/develop

## [1.10.59] - 2026-08-22

### Changes
- Merge pull request #74 from victorsdd01/develop

## [1.10.58] - 2026-08-08

### Changes
- Merge pull request #72 from victorsdd01/develop

## [1.10.57] - 2026-08-08

### Changes
- Merge pull request #70 from victorsdd01/develop
...
- **MacBook & Apple Watch as devices** in the editor's Device selector, with code-drawn (Drawn mode) laptop/watch frames laid out contain-fit below the text (no more base clipping / text overlap) and store-exact canvas.
- **Frame ↔ device match + store-exact canvas.** Selecting a device frame now sets the canvas to that device's exact App Store Connect size (iPhone 1290×2796, iPad 2064×2752, Mac 2880×1800, Apple Watch 416×496) and contain-fits the frame — so Mac/Watch/iMac frames render correctly instead of squished on a phone canvas.
...
### Changes
- Merge pull request #64 from victorsdd01/develop
